...
print("Model saved as 'color_classifier.h5'.")
...
model = tf.keras.models.load_model('color_classifier.h5')
predicted_class, confidence = predict_color(test_image_path, model, train_generator.class_indices)

print(f"Predicted Color: {predicted_class} with confidence {confidence:.2f}")
